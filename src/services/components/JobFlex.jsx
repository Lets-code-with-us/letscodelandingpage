    ...
    <div className="container mx-auto bg-white shadow-xl p-8 rounded-md">
      <section className="text-gray-600 body-font" style={{ backgroundColor: "#D2F3D4" }}>
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-col lg:flex-row w-full mb-12 justify-center items-center">
            <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
              <h1 className="text-2xl lg:text-3xl mb-2 text-center text-black font-bold">
                Specific Batch Wise Job Updates
              </h1>
              <p className="text-center mt-4 lg:mt-6 text-gray-600">
                Are you an IT professional or fresher looking for the latest job opportunities in the tech industry? Look no further! We have created a dedicated WhatsApp group that provides instant updates on IT job openings across various domains for specific batch pass-outs.
              </p>
              <p className="text-center mt-4 lg:mt-6 text-gray-600 font-bold">
                We have WhatsApp groups for batches - 2026, 2025, 2024, 2023, 2022, 2021, 2020.
              </p>
            </div>
          </div>

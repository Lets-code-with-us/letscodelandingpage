            ...
            <div className="p-2 w-full">
              <div className="h-full flex items-center bg-green-300  border-gray-200 border p-4 rounded-lg">
                <img
                  ...
                  src="https://utfs.io/f/ec34b132-08f6-4b02-9f8a-1705fbde6418-qb0aeq.png"
                />
            ...
            <div className="p-2 w-full">
              <div className="h-full flex items-center bg-green-300  border-gray-200 border p-4 rounded-lg">
                <img
                  ...
                  alt="team"
                  className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                  src="https://utfs.io/f/06c1f03d-c62c-444f-a21e-ba22408c2297-wudlxs.png"
                />
                <div className="flex-grow  ">
            ...
            <div className="p-2 w-full">
              <div className="h-full flex items-center bg-green-300  border-gray-200 border p-4 rounded-lg">
                <img
                  ...
                  alt="team"
                  className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                  src="https://utfs.io/f/5e746b41-0457-4f26-8240-1a082eb8bcaf-1svj6.png"
                />
                <div className="flex-grow  ">
                  <h2 className="text-gray-900 title-font font-medium">
                    Blog & Resources
            ...
            <div className="p-2 w-full">
              <div className="h-full flex items-center bg-green-300  border-gray-200 border p-4 rounded-lg">
                <img
                  ...
                  alt="team"
                  className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                  src="https://utfs.io/f/6ea49b1a-e567-478f-8a46-d6cfd49160c6-mm8hhe.png"
                />
                <div className="flex-grow  ">
                  <h2 className="text-gray-900 title-font font-medium">
                    Career Guidance
